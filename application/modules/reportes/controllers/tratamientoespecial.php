...
class TratamiEntoespecial extends MX_Controller
{
    public function __construct()
    {
        ...
        $this->models = $this->load->model('tratamientoespecial_model');
    ...
    public function index()
    {
        if (tiene_logeo()) {
            ...
            $xValCi = "SUB MODULO 4 - Tratamiento Especial";
            $xValMeNu = array();
            if ($xValQuery) {
                ...
                if (in_array($xValCi, $xValMeNu)) {
                    ...
                    $this->load->view('tratamientoespecial', $items);
                } else {
