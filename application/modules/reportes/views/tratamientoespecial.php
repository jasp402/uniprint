...
-->
    ...
    <script type="text/javascript">
        ...
        function div_agregar() {
            ...
            $('#titulo_div').html('Agregar Tratamiento Especial');
            $("#form")[0].reset();
            $('#div_btn_edit').hide();
            $('#div_btn_save').show();
        }
            ...
            $('#example').DataTable({
                ...
                */
                ...
                //"serverSide": true,
                    ...
                    "ajax": {
                        type: 'POST',
                        "url": 'tratamientoespecial/getAll',
                        "data": {'id': id}
                    },
                    "columns": [
                        {"data": "cod_tra_especial"},
                        {"data": null,
                        ...
                        {"data": "fecha","class":"green",
                            render: function (data, type, row) {
                               ...
                               if (data == diaActual) {
                                    ...
                                    var formattedDate = moment(diaActual).format('DD-MM-YYYY');
                                    return formattedDate+  ' <span class=\"label label-sm label-warning arrowed\">hoy</span>';
                                }else{
                                    // return data;
                                    // var data = new Date();
                                    // return moment(date).format("DD-MM-YYYY");
                                    // var date = new Date(data);
                                    var formattedDate = moment(data).format('DD-MM-YYYY'); return formattedDate;
        ...
        function save_unidad() {
            ...
            if (cod == "") {
                ...
                if (rango == undefined) {
                    ...
                    $.ajax({
                        url: 'tratamientoespecial/save_trataminto',
                        type: 'POST',
                        dataType: 'json',
        ...
        function archivar(id, nom) {
            ...
            bootbox.confirm("Estas seguro que deseas <b>deshabilitar</b> todos los registro del  estudiante <b>" +nom+"</b>?", function (result) {
                if (result) {
                    $.ajax({
                        url: 'tratamientoespecial/archivarTodo',
                        type: 'POST',
                        dataType: 'json',
                        data: {id: id},
                        beforeSend: function () {
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                Alumno con Tratamiento Especial
            </small>
        </h1>
    </div>
