...
class Tratamientoespecial_model extends CI_Model
{
    private $tabla;
    private $primary_key;
    ...
    {
        parent::__construct();
        $this->tabla = 'sys_tratamiento_especial';
        $this->primary_key = 'cod_tra_especial';
        $this->autoChecked();
    }
...
sys_alumno.nombre_1,
sys_alumno.nombre_2,
sys_tratamiento_especial.cod_alumno,
sys_tratamiento_especial.f_inicio,
sys_tratamiento_especial.f_fin,
sys_tratamiento_especial.dias,
sys_tratamiento_especial.comentario,
sys_alumno.apellido_paterno,
sys_alumno.apellido_materno,
sys_tratamiento_especial.cod_tra_especial,
sys_tratamiento_especial.estado
FROM
sys_alumno
JOIN sys_tratamiento_especial ON sys_tratamiento_especial.cod_alumno = sys_alumno.cod_alumno
WHERE estado = 1
GROUP BY
sys_alumno.cod_alumno,
sys_tratamiento_especial.fecha,
sys_alumno.nombre_1,
sys_alumno.nombre_2,
sys_tratamiento_especial.f_inicio,
sys_tratamiento_especial.f_fin,
...
sys_tratamiento_especial.cod_tra_especial,
sys_tratamiento_especial.estado
ORDER BY sys_tratamiento_especial.cod_tra_especial DESC');
      //  $query = $this->db->get();
    ...
    {
        $this->db->select('alumno.*, tratamiento.* ');
        $this->db->from('sys_tratamiento_especial tratamiento');
        $this->db->join('sys_alumno alumno', 'alumno.cod_alumno = tratamiento.cod_alumno');
    ...
    public function ListData($id)
    {
        ...
        $this->db->join('sys_alumno alumno', 'alumno.cod_alumno = tratamiento.cod_alumno');
//        $this->db->where('estado',1);
        $this->db->where('tratamiento.cod_alumno',$id);
        $this->db->order_by('tratamiento.fecha', 'asc');
