...
/**
 * -------------------------------------------------------------------------------
 * MODULO (parametros) > vehiculos | Controllers
 * -------------------------------------------------------------------------------
 *
 * Vehiculos_Controllers version 0.0.1
 *
 * Created by PhpStorm.
 * User: Jasp402
 * Date: 13/12/2016
...
class Vehiculos extends MX_Controller {
    ...
    public function __construct(){
        ...
        $this->schema['view']            = 'vehiculos';
        $this->schema['table']           = 'sys_vehiculos';
        $this->schema['pri_key']         = 'id_vehiculo';
