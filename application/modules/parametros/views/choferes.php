...
<script>
    ...
    function Save() {
        var cod = $('#nombre_apellido').val().trim();
        if (cod == "" ) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="textbox" name="nombre_apellido" id="nombre_apellido" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" name="cedula" id="cedula" maxlength="10">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        {"data": "telefono"},
                        {
                            ...
                            render: function (data, type, row) {
                                return '<div class=\"hidden-sm hidden-xs action-buttons\">'+
                                    '<a href="#modal-table_categoria" role="button" data-toggle="modal" data-rel="tooltip" title="Editar" onclick="div_form_edit('+data.id_chofer +', \'Editar Chofer\', \'choferes\')">' +
                                    '<span class=\"green\">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</span>' +
                                    '</a>'+
                                    '<a href="#" class="tooltip-error" data-rel="tooltip" title="Eliminar" onclick="Delete('+data.id_chofer +')">' +
                                    '<span class="red">' +
