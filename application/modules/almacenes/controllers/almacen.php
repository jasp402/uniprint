...
/**
 * -------------------------------------------------------------------------------
 * MODULO (almacenes) > almacen | Controllers
 * -------------------------------------------------------------------------------
 *
 * Almacen_Controllers version 0.0.1
 *
 * Created by PhpStorm.
 * User: Jasp402
 * Date: 13/12/2016
 ...
 * @version    0.0.1
 *
 *  @property almacenes_model $models                   Load all method in almacenes_model
...
class Almacen extends MX_Controller
{
    ...
    public function __construct(){
        ...
        parent::__construct();
        $this->schema['module']          = 'SUB MODULO 2';
        $this->schema['view']            = 'almacen';
        $this->schema['table']           = 'sys_ubicacion';
        $this->schema['pri_key']         = 'id_ubicacion';
        $this->schema['options']['tipo'] = 'interno';

        $this->models = $this->load->model('almacenes_model');
    ...
    /**
     * @see Traslados  traslado.js
     */
    public function LoadDestino()
    {
    $this->CRUD->read_where($this->schema['table'],$this->schema['options'],'ajax');
    }
