...
//Multiplica la (Cant. Plta) x (Unidades)
function suma() {
    var j;
    if(nextinput>0){
...
function AgregarCampos_lote(){
    ...
    campo = '<tr id="campo'+nextinput+'">'+
        ...
        '</td>'+
        '<td> ' +
        '<input type="number" name="cant_lote[]'+nextinput+'" id="cant_lote'+nextinput+'" class="form-control" onchange="suma();sumaTotales()"> ' +
        '</td>'+
        '<td> ' +
        '<input type="number" name="cant_unidades[]'+nextinput+'" id="cant_unidades'+nextinput+'" class="form-control" onkeyup="suma();sumaTotales()" onchange="suma();sumaTotales()">' +
        '</td>'+
...
//ToDo - Revisar esta funcion | genera error al guardar
...
function AgregarCampos_serie(){
    ...
    campo_serie = '<tr id="campo'+nextinput+'">'+
        ...
        '<td><input type="number" name="total[]'+nextinput+'" id="total'+nextinput+'" min="1" class="form-control"  onchange="sumaTotales()" onkeyup="sumaTotales()"></td>' +
